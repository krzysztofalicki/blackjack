...
int menu(Gracz *g, Gracz *k, int op, Talia *t)
{
	...
	cout << "Twoje karty:\t"; (*g).pokaz_reke(); (*g).licz_punkty();
	cout << endl << "Twoje punkty:\t" << (*g).punkty << endl;

	if ((*g).punkty == 0)
	{
		cout << "Krupier karty:\t"; (*k).pokaz_pierwsza();
		cout << endl << "Krupier punkty:\t" << "???" << endl << endl;

		cout << "1 graj jeszcze raz" << endl;
	...
	else if ((*g).punkty > 21)
	{
		...
		cout << "1 graj jeszcze raz" << endl;
		cout << "0 koniec gry" << endl;
		cout << "PRZEGRALES !!! Co chcesz zrobic ?" << endl << endl;
	}
	else if ((*g).punkty == 21 || ((*g).punkty > 0 && (*g).punkty < 21 && op == 3))
	{
		cout << "Krupier karty:\t"; (*k).pokaz_reke(); (*k).licz_punkty();
		cout << endl << "Krupier punkty:\t" << (*k).punkty << endl << endl;

		if ((*k).punkty > 21)
		{
			cout << "1 graj jeszcze raz" << endl;
			cout << "0 koniec gry" << endl;
			cout << "WYGRALES !!! Co chcesz zrobic ?" << endl << endl;
		}
		...
		else if ((*g).punkty == (*k).punkty)
		{
			cout << "1 graj jeszcze raz" << endl;
			cout << "0 koniec gry" << endl;
			cout << "REMIS !!! Co chcesz zrobic ?" << endl << endl;
		}
		else if ((*g).punkty < (*k).punkty)
		{
			cout << "1 graj jeszcze raz" << endl;
